...
typedef struct preview_stream_ops {
    ...
    int (*set_scale_mode)(struct preview_stream_ops *w, int mode);
...
typedef struct camera_device_ops {
    ...
    */
    ...
    // for uvc flip setting
    int (*set_usbCameraFlipStatus)(struct camera_device *, int flipEnable);

#ifdef WATERMARK_DEBUG
    //for watermark setting
    int (*set_waterMarkMultiple)(struct camera_device *, const char *mWaterMark);
#endif
} camera_device_ops_t;
